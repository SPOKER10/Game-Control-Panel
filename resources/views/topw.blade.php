...
@section('breadcrumb','Top Week Players')

@section('content')

	<div class="table-responsive">
		<table class="table">
			<thead><tr><th>#</th><th>Username</th><th>Status</th><th>Faction</th><th>Level</th><th>Respect Points</th><th>Hours Played On Week</th></tr></thead>
			<tbody>
				@foreach ($topw as $key=>$o)
					<tr>
						<td>{{ ++$key }}</td>
						...
						<td>{{ number_format($o->HWKE/3600) }} @if($key < 4) <span class="badge badge-danger">best activity</span> @endif</td>
					</tr>
				@endforeach
			</tbody>
		</table>
